...
function poplateUpdatePanelWithSelectedItem(){
    ...
    document.querySelector("#cname").value = tds[1].innerHTML;
    document.querySelector("#mname").value = tds[2].innerHTML;
    document.querySelector("#colorname").value = tds[3].innerHTML;
...
function processForm(){
    ...
    xmlhttp.onreadystatechange = function(){
        ...
        if(method ===  "PUT")
    {
        xmlhttp.open(method, "UpdateItem/items/" + itemID, true);
...
function buildTable(text){
    ...
    for(let i = 0; i < data.length; i++){
        ...
        html += "<tr>";
        html += "<td>" + temp.id + "</td>";
        html += "<td>" + temp.CompanyName + "</td>";
        html += "<td>" + temp.Model + "</td>";
        html += "<td>" + temp.Color + "</td>";
        html += "</tr>";
    }
